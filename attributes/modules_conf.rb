...
when 'redhat','centos','scientific','fedora','suse','amazon'
  default['proftpd']['conf']['if_module']['dso']['module_path'] = '/usr/libexec/proftpd'
# when 'debian', 'ubuntu' then
else
  default['proftpd']['conf']['if_module']['dso']['module_path'] = '/usr/lib/proftpd'
end
...
# default['proftpd']['conf']['if_module']['ldap']['server'] = 'ldap://ldap.example.com'
# default['proftpd']['conf']['if_module']['ldap']['bind_dn'] = '"cn=admin,dc=example,dc=com" "admin_password"'
# default['proftpd']['conf']['if_module']['ldap']['users'] = 'dc=users,dc=example,dc=com (uid=%u) (uidNumber=%u)'
...
# default['proftpd']['conf']['if_module']['ldap']['server'] = 'ldaps://ldap.example.com'
# default['proftpd']['conf']['if_module']['ldap']['bind_dn'] = '"cn=admin,dc=example,dc=com" "admin_password"'
# default['proftpd']['conf']['if_module']['ldap']['users'] = 'dc=users,dc=example,dc=com (uid=%u) (uidNumber=%u)'
...
# default['proftpd']['conf']['if_module']['sql']['auth_types'] = 'Crypt Plaintext'

# Use a backend-crypted or a crypted password
# default['proftpd']['conf']['if_module']['sql']['auth_types'] = 'Backend Crypt'

# Connection
# default['proftpd']['conf']['if_module']['sql']['connect_info'] = 'proftpd@sql.example.com proftpd_user proftpd_password'

# Describes both users/groups tables
# default['proftpd']['conf']['if_module']['sql']['user_info'] = 'users userid passwd uid gid homedir shell'
# default['proftpd']['conf']['if_module']['sql']['group_info'] = 'groups groupname gid members'
...
#
# default['proftpd']['conf']['if_module']['tls']['RSA_certificate_file'] = '/etc/ssl/certs/proftpd.crt'
# default['proftpd']['conf']['if_module']['tls']['RSA_certificate_key_file'] = '/etc/ssl/private/proftpd.key'

# CA the server trusts...
# default['proftpd']['conf']['if_module']['tls']['CA_certificate_file'] = '/etc/ssl/certs/CA.pem'
# ...or avoid CA cert and be verbose
# default['proftpd']['conf']['if_module']['tls']['options'] = 'NoCertRequest EnableDiags'
...
# default['proftpd']['conf']['if_module']['tls']['options'] = 'AllowClientRenegotiations'
...
# default['proftpd']['conf']['if_module']['vroot']['vroot_alias'] = '/var/ftp/upload upload'
# default['proftpd']['conf']['if_module']['vroot']['virtual_host']['127.0.0.1'] = {
#   'vroot_engine' => true,
